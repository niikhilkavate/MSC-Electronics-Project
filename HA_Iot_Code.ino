...
#define Switch4 26
#define WLAN_SSID "NK"
#define WLAN_PASS "Nikhil"
#define AIO_SERVER "io.adafruit.com"
#define AIO_SERVERPORT 1883
#define AIO_USERNAME "Marco"
#define AIO_KEY "aio_fAox679HmcSN"
WiFiClient client;
...
void loop() 
{
  ...
  while ((subscription = mqtt.readSubscription(20000))) 
  {
      if (subscription == &Light1) 
    {
      ...
      digitalWrite(Switch1, Light1_State);
    }
      if (subscription == &Light2) 
    {
        ...
        digitalWrite(Switch2, Light2_State);
    }
      if (subscription == &Light3) 
    {
      ...
      digitalWrite(Switch3, Light3_State);
    }
      if (subscription == &Light4) 
    {
        ...
        digitalWrite(Switch4, Light4_State);
    }
  }
}
void MQTT_connect()
